...
public class Welcome extends JFrame implements ActionListener {
	...
	private static String WelcomeHtml = "<html><h1>ab1049 - CO3201 Computer Science Project</h1>"
			...
			+ "<p>The user selects a 6 letter password. In the login stage, the user enters the first letter of the colour where each pattern pass character resides in the grid.</p>"
